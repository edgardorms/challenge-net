let data;
//peticion al backend asignacion de datos
function getData() {
  const xhr = new XMLHttpRequest();
  xhr.open("GET", "https://localhost:7049/api/stock");
...
function crearGraficos(data) {
  ...
  new Chart(document.getElementById("periodo2"), {
    type: "doughnut",
    data: {
  ...
  new Chart(document.getElementById("periodoM2"), {
    type: "doughnut",
    data: {
  ...
  new Chart(document.getElementById("periodoF2"), {
    type: "doughnut",
    data: {
  ...
  new Chart(document.getElementById("sexo2"), {
    type: "doughnut",
    data: {
      labels: labelsSexo,
      datasets: [
  ...
  new Chart(document.getElementById("edad2"), {
    type: "doughnut",
    data: {
      labels: labelsEdad,
      datasets: [
  ...
  new Chart(document.getElementById("vistas2"), {
    type: "bar",
    data: {
